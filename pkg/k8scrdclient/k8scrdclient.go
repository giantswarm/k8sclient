...
func (c *CRDClient) EnsureDeleted(ctx context.Context, crd *apiextensionsv1beta1.CustomResourceDefinition, b backoff.Interface) error {
	o := func() error {
		err := c.k8sExtClient.ApiextensionsV1beta1().CustomResourceDefinitions().Delete(ctx, crd.Name, metav1.DeleteOptions{})
...
func (c *CRDClient) ensureCreated(ctx context.Context, crd *apiextensionsv1beta1.CustomResourceDefinition) error {
	...
	_, err := c.k8sExtClient.ApiextensionsV1beta1().CustomResourceDefinitions().Create(ctx, crd, metav1.CreateOptions{})
...
func (c *CRDClient) ensureUpdated(ctx context.Context, desired *apiextensionsv1beta1.CustomResourceDefinition, b backoff.Interface) error {
	o := func() error {
		current, err := c.k8sExtClient.ApiextensionsV1beta1().CustomResourceDefinitions().Get(ctx, desired.Name, metav1.GetOptions{})
		if err != nil {
			return microerror.Mask(err)
		}
		...
		if latest && !equal {
			...
			_, err = c.k8sExtClient.ApiextensionsV1beta1().CustomResourceDefinitions().Update(ctx, copy, metav1.UpdateOptions{})
			if err != nil {
				return microerror.Mask(err)
			}
...
func (c *CRDClient) validateStatus(ctx context.Context, crd *apiextensionsv1beta1.CustomResourceDefinition, b backoff.Interface) error {
	...
	o := func() error {
		manifest, err := c.k8sExtClient.ApiextensionsV1beta1().CustomResourceDefinitions().Get(ctx, crd.Name, metav1.GetOptions{})
		if err != nil {
			return microerror.Mask(err)
		}
